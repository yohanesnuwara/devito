...
void bf0(const float h_x, const float h_y, const float h_z, struct dataobj *restrict u_vec, const int t0, const int t1, const int x0_blk0_M, const int x0_blk0_m, int x0_blk0_size, const int y0_blk0_M, const int y0_blk0_m, int y0_blk0_size, const int z_M, const int z_m, const int nthreads);

int Kernel(const float h_x, const float h_y, const float h_z, const float o_x, const float o_y, const float o_z, struct dataobj *restrict src_vec, struct dataobj *restrict src_coords_vec, struct dataobj *restrict u_vec, const int x_M, const int x_m, const int y_M, const int y_m, const int z_M, const int z_m, const int p_src_M, const int p_src_m, const int time_M, const int time_m, struct profiler * timers, const int x0_blk0_size, int y0_blk0_size, const int nthreads, const int nthreads_nonaffine)
{
